...
export const HomePortfolio = () => {
  return (
    <Container id="portfolio" margin className="flex flex-col lg:flex-row-reverse border-t-4 border-t-black py-10">
      ...
      <div className="lg:pr-10 lg:border-r-4 lg:border-r-black lg:basis-1/2">
        <Swiper
          grabCursor={true}
          centeredSlides={true}
          loop={true}
